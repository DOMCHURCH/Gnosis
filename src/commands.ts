...
export const COMMANDS: CommandDef[] = [
  ...
  { name: "/eval", desc: "evaluate whether the last turn actually succeeded" },
  { name: "/dream", args: "<task> | stop <id> | resume <id>", desc: "run a long-horizon task in the background" },
  { name: "/dreams", desc: "list active and finished dreams (status, cost, summary)" },
  { name: "/rewind", desc: "pick a turn to rewind to, or summarize up to (also: double-Esc)" },
  { name: "/security", args: "scan <path>", desc: "scan a file for exposed keys and secrets" },
  { name: "/issue", args: "<url> | status <n>", desc: "implement a GitHub issue as a dream, then open a PR" },
  { name: "/commit", args: "[--force]", desc: "commit files the security scan blocked" },
  { name: "/fix", desc: "feed a failed outcome's critique back as the next turn" },
  ...
  { name: "/undo", desc: "revert Gnosis's most recent commit (or checkpointed edit)" },
  { name: "/checkpoints", desc: "list recent Gnosis checkpoints" },
