...
const makeEngine = (cwd = "/proj") => ({ cwd, modelId: "m", mode: "ask", cost: { usd: 0 }, toolContext: undefined, messages: [], bus: undefined, bridge: undefined, agentId: 0, agentName: "", supportsImageInput() { return false; }, supportsDocumentInput() { return false; }, fork() { return makeEngine(cwd); }, abort() {} });
